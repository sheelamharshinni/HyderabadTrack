//package com.tecdatum.Tracking.School.Constants;
//
...
//    }
//}
//open fun getDirection(fromLatitude: Double, fromLongitude: Double, toLatitude: Double, toLongitude: Double) { //Getting the URL
