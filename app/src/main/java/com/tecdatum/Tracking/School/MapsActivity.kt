...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    fun drawPathdistance(result: String?) {
        ...
        try { //Parsing json
            ...
            if (Siatnceinkm.toDouble() * m < 1600.0) {
                StringDistance = Siatnceinkm
//                val dialogs = Dialog(this@MapsActivity)
//                dialogs.setContentView(R.layout.vehiclereacheddestination)
//
//                val YesBtn = dialogs.findViewById(R.id.lay_ok) as RelativeLayout
//
