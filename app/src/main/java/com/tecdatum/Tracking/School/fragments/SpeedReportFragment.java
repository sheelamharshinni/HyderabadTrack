...
public class SpeedReportFragment extends Fragment {
    ...
    Button bt_submit;
    String vehicle, S_et_speed, default_From_date_new, default_From_date, default_To_date,
            Start_time, Stop_time, default_mode, S_speed;
    String month, day;
    String S_et_fromdate, S_et_todate;
     ...
     * @return A new instance of fragment SpeedReportFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // setdate();
        //DateTimepickers_OnClicks_Recent();
...
//    public void DateTimepickers_OnClicks_Recent() {
//
////        TextView, tv_cwv_sarpunch_to, tv_cwv_upasarpunch_from, tv_cwv_upasarpunch_to, tv_cwv_panchaythsecretory_from, tv_cwv_panchaythsecretory_to, tv_cwv_previous_from, tv_cwv_previous_to, tv_cwv_present_from;
////        ImageView, iv_cwv_sarpunch_to, iv_cwv_upasarpunch_from, iv_cwv_upasarpunch_to, iv_cwv_panchaythsecretory_from, iv_cwv_panchaythsecretory_to, iv_cwv_previous_from, iv_cwv_previous_to, iv_cwv_present_from, iv_cwv_present_to;
...
//                        date_fm = java.util.Calendar.getInstance();
//
//
...
//
//                                                date_fm.set(java.util.Calendar.HOUR_OF_DAY, hourOfDay);
//                                                date_fm.set(java.util.Calendar.MINUTE, minute);
//
//                                                Log.d(TAG, "The choosen one " + date_fm.getTime());
//
//                                                android.icu.text.DateFormat df = new android.icu.text.SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
//                                                S_et_fromdate = String.valueOf(date_fm.getTime());
//                                                et_fromdate.setText(df.format(date_fm.getTime()));
//
//                                                Log.d(TAG, "The From Date " + df.format(date_fm.getTime()));
//
//                                            }
...
//
//
//                                }, currentDate.get(java.util.Calendar.YEAR), currentDate.get(java.util.Calendar.MONTH), currentDate.get(java.util.Calendar.DATE));
...
//
//                final java.util.Calendar currentDate = java.util.Calendar.getInstance();
//                date_to = java.util.Calendar.getInstance();
...
//                            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
//
//                                date_to.set(java.util.Calendar.HOUR_OF_DAY, hourOfDay);
//                                date_to.set(java.util.Calendar.MINUTE, minute);
//
...
//
//                                et_todate.setText("");
//                                et_todate.setText("" + df.format(date_to.getTime()));
//
...
//                        }, currentDate.get(java.util.Calendar.HOUR_OF_DAY), currentDate.get(java.util.Calendar.MINUTE), false).show();
//                    }
//                }, currentDate.get(java.util.Calendar.YEAR), currentDate.get(java.util.Calendar.MONTH), currentDate.get(Calendar.DATE));
...
//    }
    ...
    private void monthdayreport(String Speed) {
        ...
        //  S_et_speed = speed.getText().toString();
        ...
        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Submit",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Log.e("changed_from", default_To_date);
                        Log.e("changed_to", default_From_date);
