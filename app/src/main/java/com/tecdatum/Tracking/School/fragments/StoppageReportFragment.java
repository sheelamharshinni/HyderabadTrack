 ...
 * Use the {@link StoppageReportFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class StoppageReportFragment extends Fragment {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";

    public static final String StoppageReport = Url_new.StoppageReport;
    ...
    public static StoppageReportFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_stoppage_report, container, false);
    ...
    private void monthdayreport(String s_Speed) {
        ...
        try {
            ...
            jsonObject.put("StoppageDuration", s_Speed);
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, StoppageReport, jsonObject, new Response.Listener<JSONObject>() {
                @Override
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        if (code.equalsIgnoreCase("0")) {
                            ...
                            JSONArray jsonArray = object.getJSONArray("StoppageData");
                            ...
                            alertDialog.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    // Write your code here to invoke YES eventMonthDayReport_Fragment fragment = new MonthDayReport_Fragment();
                                    //
                                    //                                    opennfrag(fragment);
    ...
    private void setdate() {
        ...
        tv_fromandtodate.setText(default_From_date + "to " + default_From_date);
    }
