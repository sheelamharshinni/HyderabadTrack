...
class HolidayActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    class CustomInfoWindow(inflater: LayoutInflater) : GoogleMap.InfoWindowAdapter {
        ...
        override fun getInfoWindow(marker: Marker): View? {
            if (marker != null) {
                if (MapsActivity.markerPlaces.containsAll(Collections.singleton(marker.getId()))) {
                ...
                } else if (MapsActivity.markerPlaces1.containsAll(Collections.singleton(marker.getId()))) {
